        ...
        return (
            <div className='Header'>
                ...
                {/* large create box */}
                {
                    ...
                    <CreateBox unmount={() => this.setState({createBox: false})} refreshRecipes={this.props.refreshRecipes} ipcRenderer={this.props.ipcRenderer} initialValue={this.state.createBox}/>
                }
